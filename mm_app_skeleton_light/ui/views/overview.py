...
class OverviewView(ttk.Frame):
    def __init__(self, master):
        ...
        self.table = DataTable(self, height=20)
        self.table.pack(fill="both", expand=True, padx=14, pady=14)

    def render(self, summary: dict, df_preview: pd.DataFrame | None) -> None:
        ...
        self.table.set_dataframe(df_preview if df_preview is not None else pd.DataFrame())
